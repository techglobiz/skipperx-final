...
import './Navbar.css'; // We'll reuse the same styles
...
const HomeHeader = () => {
  ...
  return (
    <>
      <nav className="navbar home-navbar"> {/* Added home-navbar class for specific styling */}
      ...
      <div className={`nav-buttons ${open ? 'show' : ''}`}>
        ...
        <Link href="/contact" className="navlink" ><button className="btn white">Get Started</button></Link>
      </div>
