...
export default function CoretechPage() {
  ...
  <div className="stack-section">
    ...
    <h1 className="drone-title">
      Everything to Help You Learn Tech and Get <br/> Ahead —  
      <span className="highlight"> Tech Core</span> has you Covered
    </h1>
  ...
  {/* NEW STACK MODULES SECTION */}
        <div className="stack-card-container">
         <Image src={coretech} alt="Stack Up" className="stack-up-image" />
        </div>   
