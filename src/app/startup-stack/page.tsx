...
import stackgrph from "/public/assets/stacklogo/stackgrph.png";
        ...
        <div className="stack-card-container desktop-only">
          <Image src={statckimg} alt="Stack Up" className="stack-up-image" />
           ...
           <div className="stack-card-container mobile-only">
            <Image src={stackgrph} alt="Stack Up" className="creatorsmob" />
          </div>
                  ...
                  {[
                    {
                      ...
                      label: "business strategy, analytics, and innovation",
                    },
                    {
                      count: "Learn top tools for finance, ",
                      label: "stock trading, and AI-powered decisions",
                    },
                    {
                      count: "Explore creative domains like",
                      label: "fashion and consumer psychology",
                    },
                    {
                      count: "Train for real roles with expert",
                      label: " mentors, case studies, and hands-on practice",
                    },
                  ].map((item, index) => (
